...
1. Follow the **Setup Runbook**
2. Run tests locally using the **Running Tests Guide**
3. Review pipeline behaviour in **Pipelines Guide**
4. Follow **Coding Standards** when extending tests

---

## 🎯 Key Principle

> This starter pack provides a baseline.  
> Teams should extend it with application-specific setup while maintaining STP standards.